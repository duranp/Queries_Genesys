...
SET @DESDE = '01/11/2012'--DBO.DMY(GETDATE()-1)--case when datepart(day,getdate())<9 then dbo.pd(dateadd(month,-1,getdate())) else dbo.pd(getdate()) end 
SET @HASTA = '30/11/2012'--DBO.DMY(GETDATE())
