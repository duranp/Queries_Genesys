...
--FE DE ERRATAS 	'FE DE ERRATAS '+
	...
	WHERE U.NAME  in ('DNS265', 'DNS288', 'DNS267', 'DNS227', 'DNS292', 'DNS116', 'DNS291', 'DNS212', 'DNS104', 'DNS203')
...
from cartera c 
	inner join roster_cm r on c.name = r.name 
		and r.name in ('DNS265', 'DNS288', 'DNS267', 'DNS227', 'DNS292', 'DNS116', 'DNS291', 'DNS212', 'DNS104', 'DNS203')
*/