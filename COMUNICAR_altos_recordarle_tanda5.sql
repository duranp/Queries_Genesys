...
SELECT * FROM ROSTER_CM WHERE LASTNAME LIKE '%boggiano%'
Blanzari, Silvana Paola
Orellana, Marisel
Sanchez Valeria
MARIA EUGENIA MATTHYS
SERGIO RAUL CONTARDI
SOLEDAD CRIVELLI
MARTIN DIEGO ARMANDO CONTRERAS
MARTIN DIEGO ARMANDO CONTRERAS
NATALIA SOLEDAD BOGGIANO
VERONICA CORRADO
